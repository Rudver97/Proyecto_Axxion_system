...
-- ------------------------------------------------------------------------------------- --
ALTER TABLE USUARIOS ADD Productos DATE;

-- ------------------------------------------------------------------------------------- --
-- 07. Renombrar Columna. -------------------------------------------------------------- --
--     ALTER TABLE __ CHANGE __ __ : --------------------------------------------------- --
-- ------------------------------------------------------------------------------------- --
ALTER TABLE USUARIOS CHANGE direccion alertas VARCHAR(100);
...
CREATE TABLE USUARIOS (  
  nombre INT NOT NULL,
  correo_electronico VARCHAR(10) NOT NULL,
  contraseña VARCHAR(50) NOT NULL,
  mantenimiento_id VARCHAR(50) NOT NULL,
  mantenimiento_producto_id VARCHAR(100) NOT NULL
);
